...
"[project]/app/api/time-records/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function PATCH(request, { params } // Tipado como Promise
) {
    try {
        // 1. Aguarde o desmembramento (unwrap) dos params primeiro
        const { id } = await params;
        const data = await request.json();
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].timeRecord.update({
            where: {
                id: id
            },
            data
...
async function DELETE(request, { params }) {
    try {
        // 1. Aguarde o desmembramento (unwrap) dos params primeiro
        const { id } = await params;
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].timeRecord.delete({
            where: {
                id: id
            }
        });
...
//# sourceMappingURL=_81e5071f._.js.map