    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <StatCard
          ...
          subvalue={
            totalOvertime > 0
              ? `${(totalOvertime / 60).toFixed(1)} horas`
              : 'Nenhuma'
          }
          color="amber"
        />
      ...
      <Card className="bg-blue-50 border-blue-100 p-4">
        ...
        <ul className="text-xs text-blue-700 space-y-1">
          <li>
            • O total considera os dois períodos de trabalho registados no dia
          </li>
          <li>
            • O resumo de horas extra mostra o excedente acima das 8h diárias
          </li>
          <li>
            • Este painel é informativo e não substitui regras laborais
            específicas
          </li>
        </ul>
      </Card>
